...
#define BETELGEUSE_TS_IRQ		TEGRA_GPIO_PJ7
#define BETELGEUSE_TS_RESET	TEGRA_GPIO_PH1
#define BETELGEUSE_TS_POWER	TEGRA_GPIO_PK2
//#define BETELGEUSE_TS_DISABLE	TEGRA_GPIO_PAA6 /* 0=enabled */
