...
#if defined (BETELGEUSE_EMC_SAMSUNG)
...
#elif defined (BETELGEUSE_EMC_ELPIDA50NM)
...
#elif defined (BETELGEUSE_EMC_ELPIDA40NM)
...
#else
	tegra_init_emc(betelgeuse_emc_tables, ARRAY_SIZE(betelgeuse_emc_tables));
#endif
}
