...
static struct tegra_gpio_table gpio_table[] = {
	...
	{ .gpio = BETELGEUSE_TS_POWER,		.enable = true },
	{ .gpio = BETELGEUSE_TS_RESET,		.enable = true },
...
void __init betelgeuse_pinmux_init(void)
{
	...
	tegra_drive_pinmux_config_table(betelgeuse_drive_pinmux,
		ARRAY_SIZE(betelgeuse_drive_pinmux));
